...
data "template_file" "docker" {
  ...
  vars {
    ...
    # TODO link built rds uri into dockerfile
  }
}
...
data "archive_file" "zip" {
  ...
  output_path = "./${var.application_name}-Dockerfile.zip"
}
...
resource "aws_s3_bucket_object" "default" {
  ...
  key    = "${var.application_name}-Dockerfile"
  source = "./${var.application_name}-Dockerfile.zip"
